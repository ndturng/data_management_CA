...
urlpatterns = [
    ...
    path("<int:pk>/salary-process", views.officer_salary_process, name="officer_salary_process"),
    path("<int:pk>/laudatory", views.officer_laudatory, name="officer_laudatory"),
    path("<int:pk>/discipline", views.officer_discipline, name="officer_discipline"),
    ...
    path("<int:pk>/army-join-history", views.officer_army_join_history, name="officer_army_join_history"),
